...
| Apps       | `apps list`, `apps update <alias> [--env-file <file>]`, `apps delete <alias>`, `apps restart <alias> --service <name>` (per-service rolling restart) |
